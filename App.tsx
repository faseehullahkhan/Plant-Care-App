...
const App: React.FC = () => {
  ...
  useEffect(() => {
    // Load plants from local storage on initial render
    try {
    ...
    if (plants.length === 0) {
      return (
        <div className="text-center py-20 px-6 animate-fade-in-up">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 dark:text-gray-100 tracking-tight">Welcome to Your Virtual Garden</h2>
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
        {currentPage === 'dashboard' ? renderDashboard() : <ExplorePlants />}
      </main>
