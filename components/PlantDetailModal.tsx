...
import { LeafIcon, XIcon, RulerIcon, ChartBarIcon, PlusIcon, CalendarIcon, TrendingUpIcon } from './Icons';
...
export const PlantDetailModal: React.FC<PlantDetailModalProps> = ({ plant, onClose, onAddGrowthEntry }) => {
      ...
      >
        <div className="flex justify-between items-center p-4 sm:p-5 border-b border-gray-200 dark:border-slate-800 flex-shrink-0 bg-white dark:bg-slate-800 rounded-t-xl">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-semibold capitalize text-gray-800 dark:text-gray-100">{plant.name} - Dashboard</h2>
          </div>
