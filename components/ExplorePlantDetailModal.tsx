    ...
    >
      ...
      >
        ...
        <div className="p-4 sm:p-6">
          <div className="mb-6 rounded-lg overflow-hidden shadow-lg h-64 bg-gray-100 dark:bg-slate-700">
             {plant.imageUrl ? (
                <img src={plant.imageUrl} alt={plant.name} className="w-full h-full object-cover" />
              ) : (
                <div className="flex items-center justify-center w-full h-full">
                    <LeafIcon className="w-16 h-16 text-gray-300 dark:text-slate-500" />
                </div>
              )}
          </div>
